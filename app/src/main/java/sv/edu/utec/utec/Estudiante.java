...
public class Estudiante extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().beginTransaction().replace(R.id.conteniEstudiantes,perfil).commit();
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            Fragment perfil1=new Estudiantes_Laboratorios();
            getSupportFragmentManager().beginTransaction().replace(R.id.conteniEstudiantes,perfil1).commit();
